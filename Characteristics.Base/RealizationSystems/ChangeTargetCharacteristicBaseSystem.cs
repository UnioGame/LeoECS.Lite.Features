...
#endif
    [Serializable]
    public class ChangeTargetCharacteristicBaseSystem<TCharacteristic> : IEcsInitSystem, IEcsRunSystem
        where TCharacteristic : struct
    {
        private EcsWorld _world;
        private EcsFilter _changeRequestFilter;
        
        private EcsPool<ChangeCharacteristicBaseRequest<TCharacteristic>> _requestPool;
        
        private EcsPool<ChangeCharacteristicBaseRequest> _changePool;
