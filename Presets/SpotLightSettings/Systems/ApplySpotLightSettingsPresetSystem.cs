namespace Game.Ecs.Presets.SpotLightSettings.Systems
{
    ...
    [Serializable]
    [ECSDI]
    public class ApplySpotLightSettingsPresetSystem : IEcsInitSystem, IEcsRunSystem
    {
        private EcsWorld _world;
        private EcsFilter _targetFilter;

        private EcsPool<PresetApplyingDataComponent> _applyingDataPool;
        private EcsPool<SpotLightSettingsPresetComponent> _presetPool;
